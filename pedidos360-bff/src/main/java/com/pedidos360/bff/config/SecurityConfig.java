    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                // Health pública para el SPA (no expone datos) y el resto requiere token válido
            ...
            .exceptionHandling(e -> e
                .authenticationEntryPoint((req, res, ex) -> {
                    ...
                    res.getWriter().write("{\"error\":\"Token inválido o ausente. El BFF solo permite consumir endpoints con un token válido de Azure AD.\"}");
                }))
